...
$string['modulename_help'] = 'Use the widget module for creating a live session.| The widget module allows teachers to create a live course, and students to watch it.';
$string['widgetfieldset'] = 'Custom example fieldset';
$string['widgetname'] = 'live course name';
